...
La documentación actualizada de la API (HU-01 a HU-09) está en [docs/backend-endpoints.md](./docs/backend-endpoints.md).

> Nota: el README anterior listaba endpoints legacy (register, verifyEmail, etc.) que ya no corresponden al front actual. Usa el archivo de documentación para contratos oficiales.
